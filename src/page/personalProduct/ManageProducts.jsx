    ...
    <>
      ...
      <div className="container mx-auto py-24">
        ...
        <button 
          ...
          className="bg-green-600 text-white font-bold py-2 px-6 rounded transition duration-300 ease-in-out transform hover:bg-green-500 hover:scale-105 shadow-md hover:shadow-lg mb-4"
        >
          Tạo Sản Phẩm Mới
        </button>
