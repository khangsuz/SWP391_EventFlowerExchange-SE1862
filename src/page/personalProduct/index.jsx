            ...
            <div className="flex items-start">
              ...
              <div className="ml-5">
                ...
                <div className="flex mt-5 space-x-3">
                  <button className="text-sm bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg py-2 px-5" onClick={handleChat}>
                    Chat Ngay
                  </button>
                  <button className="text-sm text-blue-600 border-2 border-blue-600 rounded-lg py-2 px-5">
                    Yêu Thích
                  </button>
        ...
        <div className="product-grid">
          {sellerProducts.length > 0 ? (
            ...
            <div className="w-full text-center py-8">
              ...
              {currentUserId === parseInt(userId) && (
                <button className="mt-4 bg-blue-500 text-white font-bold py-2 px-4 rounded" onClick={handleManageProducts}>
                  Thêm sản phẩm mới
                </button>
              )}
            </div>
