      ...
      <div className="flex space-x-4">
        ...
        {currentUser ? (
          <Tippy content={`Hi, ${userData ? userData.name : 'User'}`} placement="bottom">
            ...
            <img
              src={userData ? userData.profileImageUrl : 'path/to/default/image.jpg'} // Thay 'path/to/default/image.jpg' bằng đường dẫn đến ảnh mặc định nếu không có ảnh người dùng
              alt="Profile"
              className="w-7 h-7 rounded-full" // Thay đổi kích thước và kiểu dáng theo ý muốn
            />
            </Link>
          </Tippy>
        ) : (
